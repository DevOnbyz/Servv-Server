...
const getIssueReportDetails = (database, startDate, endDate) => {
  ...
  CASE 
    ...
    WHEN I.sub_status = ${CONSTANTS.ISSUE_SUB_STATUS_NUM.WORK_CANCELLED} THEN "WORK CANCELLED"
    WHEN I.sub_status = ${CONSTANTS.ISSUE_SUB_STATUS_NUM.INVOICE_DRAFTED} THEN "INVOICE DRAFT"
