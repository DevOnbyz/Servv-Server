module.exports = {
  ...
  RESIDENT_MESSAGE_TYPE : {
    SITE_VISIT_SCHEDULED: "siteVisitScheduled",
    SITE_VISIT_RESCHEDULED: "siteVisitRescheduled",
    SITE_VISIT_CANCELED: "siteVisitCanceled",
    ESTIMATE_AVAILABLE: "estimateAvailable",
    WORK_SCHEDULED: "workScheduled",
    WORK_RESCHEDULED: "workRescheduled",
    WORK_CANCELED: "workCanceled",
    INVOICE_READY: "invoiceReady",
    NEW_ANNOUNCEMENT: "newAnnouncement"
},

 AGENT_MESSAGE_TYPE : {
  SITE_VISIT_ASSIGNED: "siteVisitAssigned",
  SITE_VISIT_CANCELED: "siteVisitCanceled",
  SITE_VISIT_RESCHEDULED: "siteVisitRescheduled",
