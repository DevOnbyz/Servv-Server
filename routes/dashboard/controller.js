...
exports.getDashbordDataController = async (request, response) => {
    ...
    try {
        const dashBoardData = await runQueryOne(CONSTANTS.BUILDING_DATABASE, queryBuilder.getDashboardData(CONSTANTS.BUILDING_DATABASE,orgID))
        ...
        sendHTTPResponse.error(response, 'Error while f etching Dashboard');
    }
};