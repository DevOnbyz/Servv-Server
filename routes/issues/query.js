...
module.exports = {
  ...
  getIssues(database) {
    return `SELECT I.id, A.name as doorNo, P.name as projectName, CONCAT(AG.firstname, ' ', COALESCE(AG.lastname, '')) AS agentName, I.agent_id as agentID ,CONCAT(R.firstname, ' ',  COALESCE(R.lastname, '')) as name,I.rating as rating,
