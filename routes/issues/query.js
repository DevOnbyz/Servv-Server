...
module.exports = {
  ...
  getIssues(database) {
    ...
    I.created_at, RI.ph_num as phNum, I.description as issueDescription, S.name as serviceType, S.id as serviceID, I.customer_preferred_time as scheduledTime, I.initial_activity_time as initialActivityTime,
    I.img_src
