...
module.exports = {
  ...
  getIssuesEvent(database) {
    return `SELECT DISTINCT
        ...
        IE.entity_id, 
        IE.creator_type, 
        (SELECT visit_scheduled_time FROM ${database}.agent_assignment WHERE issue_id = IE.issue_id AND IE.sub_status IN (${ISSUE_SUB_STATUS_NUM.SITE_VISIT_ASSIGNED}, ${ISSUE_SUB_STATUS_NUM.WORK_ASSIGNED}) ORDER BY created_at DESC LIMIT 1) as event_time,
        IE.created_at,
